      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-2/5 bg-linear-to-br from-primary-600 via-primary-700 to-secondary-900 p-12 flex-col justify-between">
        ...
        <div className="space-y-6">
          <h1 className="text-4xl font-bold text-white leading-tight">
            Gerencie a performance dos seus pacientes
          </h1>
          <p className="text-lg text-primary-100/80">
            Plataforma completa para acompanhamento de saúde, lesões, tratamentos e evolução de pacientes profissionais.
          </p>
          <div className="flex gap-8 pt-4">
            <div>
              <div className="text-3xl font-bold text-white">500+</div>
              <div className="text-sm text-primary-200">Pacientes monitorados</div>
            </div>
            <div>
